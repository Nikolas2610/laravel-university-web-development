...
<div class="container mt-5">
    ...
    <form action="{{ route('import.offer') }}" method="post" class="mt-5" id="importForm" onsubmit="return validateImportOfferForm(event)">
        @csrf
        ...
        <x-register-row label="Τιμή:" note="(Σημ: Αριθμός)" id="amount">
            <x-form-input id="amount" name="amount" type="number" max="999999999" step="1"/>
        </x-register-row>
        ...
        <div class="row mb-4">
            <div class="col text-center">
                <button class="btn btn-secondary rounded-xxl px-4 border border-dark border-2 bg-dark-gray" type="submit">
                    Καταχώρηση
                </button>
            </div>
        </div>
